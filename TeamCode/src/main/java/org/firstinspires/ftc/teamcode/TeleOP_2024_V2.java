...
@TeleOp(name="TeleOP_2024_V2", group="Iterative Opmode")
//@Disabled
public class TeleOP_2024_V2 extends OpMode
{
    ...
    //int WantedBratLevelDown = 0;
    //int WantedBratLevelUp = 0;
    /*
    ...
    public void loop(){
        ...
        //daca trebuie ridicat sau coborat (controlat) bratul
        /*if(gamepad1.x && driveBrat <= System.currentTimeMillis()) {
            //x il ridica
            driveBrat = System.currentTimeMillis() + 250;
            WantedBratLevelUp = 1;
            WantedBratLevelDown = 0;
        }
        if(gamepad1.b && driveBrat <= System.currentTimeMillis()) {
            //b il coboara
            driveBrat = System.currentTimeMillis() + 250;
            WantedBratLevelDown = 1;
            WantedBratLevelUp = 0;
        }
        if(driveBrat > System.currentTimeMillis() && WantedBratLevelUp == 1)
            ServoBratSuperior.setPosition(0.4);
        else if(driveBrat > System.currentTimeMillis() && WantedBratLevelDown == 1)
            ServoBratSuperior.setPosition(startPositionBrat);
        else if(driveBrat <= System.currentTimeMillis() && WantedBratLevelUp == 1)
            WantedBratLevelUp = 0;
        else if(driveBrat <= System.currentTimeMillis() && WantedBratLevelDown == 1)
            WantedBratLevelDown = 0;*/
        ...
        if(driveBrat > System.currentTimeMillis()){
            if(wantedBratLevel % 2 == 1) {
                ...
                if(!isIncremented) {
                    pozitieExtraFaras = System.currentTimeMillis() + 150;
                    wantedFarasLevel++;
                    isIncremented = true;
                }
            }
        ...
        telemetry.addData("drivefaras este ", "%d", driveFaras);
